...
void gpio_port_ta_init(){
	MCF_GPIO_PTAPAR = MCF_GPIO_PTAPAR_PTAPAR1(MCF_GPIO_PTAPAR_GPT1_GPIO) |
			MCF_GPIO_PTAPAR_PTAPAR2(MCF_GPIO_PTAPAR_GPT2_GPIO);
	
	
	MCF_GPIO_PORTTA &=  ~(MCF_GPIO_DDRTA_DDRTA1 | 
		        MCF_GPIO_DDRTA_DDRTA2);
	
	MCF_GPIO_DDRTA = MCF_GPIO_DDRTA_DDRTA1 |
				MCF_GPIO_DDRTA_DDRTA2;
